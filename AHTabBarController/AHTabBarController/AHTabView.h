...
//The subitems that will be showed wehenever this tab is tapped. If the tab only contains one item
// no extra menu will be shown and the user will directly see the subitem's viewcontroller.
...
//Adds a subitem ot the subitems array
